...
Param (
    ...
    [HashTable]$Script = @{
        UserAccounts             = '..\User accounts import export\User accounts import export.ps1'
        UserGroups               = '..\User groups import export\User groups import export.ps1'
        FirewallRules            = '..\Firewall rules import export\Firewall rules import export.ps1'
        CreateFolders            = '..\Folders import export\Folders import export.ps1'
        SmbShares                = '..\Smb shares import export\Smb shares import export.ps1'
        RegionalSettings         = '..\Regional settings import export\Regional settings import export.ps1'
        NetworkCards             = '..\Network cards import export\Network cards import export.ps1'
        NtpTimeServers           = '..\NTP time servers import export\NTP time servers import export.ps1'
        RegistryKeys             = '..\Registry keys import export\Registry keys import export.ps1'
        ScheduledTasks           = '..\Scheduled tasks import export\Scheduled tasks import export.ps1'
        CopyFilesFolders         = '..\Copy files folders import export\Copy files folders import export.ps1'
        Software                 = '..\Software import export\Software import export.ps1'

...
Param (
    ...
    [System.Collections.Specialized.OrderedDictionary]$Snapshot = [Ordered]@{
        RegionalSettingsCurrentAccount = $true
        RegionalSettingsNewAccounts    = $true
        UserAccounts                   = $true
        UserGroups                     = $true
        FirewallRules                  = $true
        SmbShares                      = $true
    ...
    [HashTable]$Script = @{
        ...
        RegionalSettingsCurrentAccount = 'Scripts\Regional settings current account import export\Regional settings current account import export.ps1'
        RegionalSettingsNewAccounts    = 'Scripts\Regional settings new accounts import export\Regional settings new accounts import export.ps1'
